...
python -u main.py --data_dir $dir --dataset $data -c $classes --arch $model --bits 8 -e 2 --outdir "results/cifar10/coe10/" -coe 10
python -u main.py --data_dir $dir --dataset $data -c $classes --arch $model --bits 8 -e 2 --outdir "results/cifar10/coe100/" -coe 100
